...
const MentorForm = () => {
  const fields = [
    ...
    { label: 'Contact', placeholder: 'Enter mobile no.' },
    { label: 'Department', placeholder: '----' },
    { label: 'Qualification', placeholder: 'Enter qualification' },
    { label: 'Year Of Experience', placeholder: 'Enter experience' },
    ...
    <SafeAreaView className="flex-1">
      ...
      >
        ...
        <View className="mt-10 mb-6 px-6">
          <Text className="text-white text-4xl font-extrabold text-center">Mentor Information</Text>
