...
const CourseDetail = () => {
  const fields = [
    ...
    { label: 'Department', placeholder: 'Enter your department' },
    { label: 'Year', placeholder: '-- Year' },
    { label: 'Semester', placeholder: '--' },
    { label: 'Enrollment No.', placeholder: '--' },
  ];
    ...
    <SafeAreaView className="flex-1">
      ...
      >
        ...
        <View className="mx-5 bg-[#0b0f1a]/70 border border-gray-700 rounded-3xl px-5 py-7 shadow-lg shadow-black/40">
          <Text className="text-white text-2xl font-bold text-center mb-5">Course Details</Text>
          ...
          <Pressable
            ...
            onPress={() => router.push('/Forms/StudentForm/collegeDetail')}
          >
