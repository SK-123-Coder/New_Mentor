...
const CollegeDetail = () => {
  const fields = [
    { label: 'College', placeholder: 'Enter your college name' },
    { label: 'City', placeholder: 'Enter city' },
    { label: 'State', placeholder: 'Enter state' },
    { label: 'University', placeholder: 'Enter university name' },
  ];
    ...
    <SafeAreaView className="flex-1">
      ...
      >
        ...
        <View className="mx-5 bg-[#0b0f1a]/70 border border-gray-700 rounded-3xl px-5 py-7 shadow-lg shadow-black/40">
          <Text className="text-white text-2xl font-bold text-center mb-5">College Details</Text>
